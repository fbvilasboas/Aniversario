...
def enviar_email(lista_aniversariantes, mes):
    try:
        ...
        <html>
            <head>
                <style>
                    ...
                    .background {{
                        background: url('https://via.placeholder.com/600x200') no-repeat center center;
            ...
            <body>
                <div class="background">
                    ...
                    <div class="lista">
                        <ul>
                            <!-- Abaixo está o loop Python, usado para gerar os itens dinamicamente -->
                            {''.join(
        ...
        # Adicionar todos os e-mails no campo
        
        #
        #PARA ENVIAR PARA e-mail de teste thiago.sleite@agu.gov.br e fernando.vilasboas@agu.gov.br
        #
        destinatarios = "thiago.sleite@agu.gov.br;fernando.vilasboas@agu.gov.br"
        mail.to = destinatarios  # 

        #PARA ENVIAR PARA TODA A LISTA DE E-MAIL USAR A LINHA ABAIXO:
        #destinatarios = ";".join(lista_emails)

        # Anexar a imagem FELIZ.PNG
        #caminho_imagem = r"FELIZ.PNG"  # Certifique-se de que o caminho da imagem está correto
        #anexo = mail.Attachments.Add("FELIZ.PNG")
